 ...
 |__   __|                                              
    ...
    |_|.|___/.|  __/ 
			...
			if(!extension_loaded("openssl")){
				$this->logger->warning("æ¾ä¸å° OpenSSL æ©å±,è¯·éæ°å®è£PHP,å¦åæ æ³ä½¿ç¨XBoxéªè¯ && æè´¨ååè½(å¼åä¸­).");
				$this->setConfigBool("online-mode", false);
			}elseif(!$onlineMode){
				$this->logger->warning("æå¡å¨å¤å¨ç¦»çº¿æ¨¡å¼!");
			}
